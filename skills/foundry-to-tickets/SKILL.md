...
metadata:
  ...
  origin-path: skills/engineering/to-tickets/SKILL.md
  origin-revision: d29732e49f60a71e2036471c8eaa31631bf5151c
...
The issue tracker and triage label vocabulary should have been provided to you — run `/foundry-setup-matt-pocock-skills` if not.
...
Publish the approved tickets. **How** depends on the tracker `/foundry-setup-matt-pocock-skills` configured — the tickets are the same either way, only the shape of the blocking edges changes:
...
Work the frontier one ticket at a time with `/foundry-implement`, clearing context between tickets.
</content>
