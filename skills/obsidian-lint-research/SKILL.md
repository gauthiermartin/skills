...
```bash
SKILL_DIR="${CLAUDE_PLUGIN_ROOT:-$HOME/.claude}/skills/obsidian-lint-research"
RD="<research_dir>"
...
| missing-comparisons | NO | flag — user can `/obsidian-render-research comparison <a> <b>` if they want |
...
- For missing comparisons: run /obsidian-render-research comparison <a> <b>
